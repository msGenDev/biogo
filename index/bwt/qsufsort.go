...
func sortedByFirstLetter(data alphabet.Letters) []int {
	// total byte counts
	var count [256]int
	for _, b := range data {
		count[b]++
...
func initGroups(sa []int, data alphabet.Letters) []int {
